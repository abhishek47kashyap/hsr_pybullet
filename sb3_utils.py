"""
https://colab.research.google.com/github/Stable-Baselines-Team/rl-colab-notebooks/blob/sb3/monitor_training.ipynb#scrollTo=BIedd7Pz9sOs
...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def __init__(self, check_freq: int, log_dir: str, model_name: str, verbose=1):
        ...
        self.save_path = os.path.join(log_dir, 'best_model', model_name)
